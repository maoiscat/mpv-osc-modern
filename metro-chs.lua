...
function prepare_elements()
    ...
    for _,element in pairs(elements) do
        ...
        elseif (element.type == "slider") then
            ...
            static_ass:draw_start()
			-- a hack which prepare the whole slider area to allow center placements such like an=5
			ass_draw_rr_h_cw(static_ass, 0, 0, elem_geo.w, elem_geo.h, 0)
			ass_draw_rr_h_ccw(static_ass, 0, 0, elem_geo.w, elem_geo.h, 0)
            -- marker nibbles
